...
Furthermore, results will be obscured if a mixed culture is obtained, particularly if the cultures are obtained from sites with microbiota, such as the gut and the skin, increasing the risk of contamination by normal flora and leading to false results \citep{giuliano_guide_2019}. 
...
\begin{itemize}
    ...
    \item Develop novel methods and metrics to accurately identify and estimate relative abundance of pathogens of interest through a hybrid approach of read mapping and \textit{de novo} assembly methods;
