...
For the purpose of this dissertation work, we will be focusing on bacterial (see Section \ref{sssec:_intro_bacterial} and viral infections (see Section \ref{sssec:_intro_viral}.
...
Syndromic testing (see \secref{sssec:_intro_bacterial}) is now fully integrated into the standard testing practices of many clinical laboratories \citep{dien_bard_panels_2020}. 
