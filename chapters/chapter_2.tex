...
As mentioned in \ref{sssec:shotgun_metagenomics}, shotgun metagenomic (SMg) approaches have been a growing interest to deliver clinically relevant results without \textit{a priori} knowledge of what to expect from a particular clinical sample or patient. 
